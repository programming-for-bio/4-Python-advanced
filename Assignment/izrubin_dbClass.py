...
"""
Class object with attricutes and functions to assemble
de Bruijn and eulerian path information.
"""
...
class Assembler5():
    """
    An object for constructing a debruijn graph from kmers of random reads
    """
    ...
    ## new function to call .run() function over a range of parameter values
    ## in a for-loop and return the results as a dictionary.
    def test(self, nreads, rlen, k):
        """
        tests assembler object parameter values and returns
