...
"""
Creates a class object called "Assembler" which consists of functions for assembling contigs from sequenced reads 
using kmers (self.run()) and for creating a debruijn graph (self.plot()).
"""
...
class Assembler():
    ...
    def test(self, nreads, rlen, k):
        "Calls the .run() function over a range of parameter values in a for-loop and return the results as a dictionary"
        self.run(nreads, rlen, k)
        result_dict = {}
