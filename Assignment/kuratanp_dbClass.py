...
"""
Data Programming and Data Science for Biologists: Assigment4-3
"""
...
class Assembler5():
    ...
    """
    This Assimbler Class test over many different parameters to see how they affect our ability to assemble the target sequence.
    """
    ...
    def test(self):
         """
         Test the assembler over different values including target size[200, 500, 1000], number of reads[500, 1000, 5000], and 
         length of kmers [10, 20, 30].
         """
        result_dict = {}
